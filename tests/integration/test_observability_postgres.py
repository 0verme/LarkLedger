...
async def test_readyz_200_when_database_and_migration_are_current(
    ...
    app = _app(postgres_session_factory, expected_revision="20260828_0029")
    ...
    assert body["checks"]["migration"]["current"] == "20260828_0029"
    assert body["checks"]["migration"]["expected"] == "20260828_0029"
...
async def test_readyz_503_when_migration_is_behind(
    ...
    # The real database is at head 20260828_0029; a deployment whose code
...
async def test_readyz_503_when_database_is_unreachable(
    ...
    try:
        ...
        app = _app(factory, expected_revision="20260828_0029")
...
async def test_ops_status_aggregates_real_rows(
    ...
    app = _app(
        ...
        expected_revision="20260828_0029",
