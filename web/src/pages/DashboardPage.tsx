...
export function DashboardPage() {
	...
	const currentLedger = (ledgers.data?.items ?? []).find((item) => item.is_current);
		...
		<div className="dashboard-page">
			...
			<div className="dash-hero">
				...
				<div className="hero-cta">
					...
					<Link className="quiet-button" to="/entries">查看全部流水</Link>
				</div>
			</div>
